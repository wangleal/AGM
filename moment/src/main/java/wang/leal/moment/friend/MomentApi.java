...
public interface MomentApi {
    ...
    @POST("/v1/create")
    @FormUrlEncoded
    Observable<Object> createMoment(@Field("lock_resource_id")String lockResourceId,@Field("open_resource_id")String openResourceId,@Field("location")String location,
