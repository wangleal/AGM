...
public class CameraWrapperSurfaceRender implements SurfaceViewGLWrapper.Renderer,SurfaceTexture.OnFrameAvailableListener {
    ...
    public CameraWrapperSurfaceRender(SurfaceView surfaceView) {
    ...
    private void openFrontCamera() {
        try {
            camera.openFront(surfaceView.getHeight(), surfaceView.getWidth(), 24);
            startPreview();
            CameraInfo currentCameraInfo = camera.getCameraInfo();
            if (currentCameraInfo != null) {
    ...
    private void openBackCamera() {
        try {
            camera.openBack(surfaceView.getHeight(), surfaceView.getWidth(), 24);
            startPreview();
            CameraInfo currentCameraInfo = camera.getCameraInfo();
            if (currentCameraInfo != null) {
