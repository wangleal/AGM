...
class CameraUtil {
    ...
    static void setPreviewSize(android.hardware.Camera.Parameters params, int desiredLong,int desiredShort) {
        if (params != null) {
            try {
    ...
    static void setFixedPreviewFps(android.hardware.Camera.Parameters params, int desiredFps) {
    ...
    static void setAdvancedCameraParameters(android.hardware.Camera.Parameters paramParameters)
    {
    ...
    static boolean isSupported(String paramString, List<String> paramList)
    {
